                      ...
                      <Link href={`/inventory/${car.id}`} className="block">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-amber-50 group-hover:bg-amber-500 text-amber-600 group-hover:text-white text-xs font-bold transition-colors">
                              Details
